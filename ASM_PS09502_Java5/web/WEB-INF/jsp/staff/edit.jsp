...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form:form action="${pageContext.servletContext.contextPath}/staff/edit.html?idofstaff=${idofstaff}" modelAttribute="staff" method="post" cssClass="form-horizontal">
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="staffid">StaffID</label>
                        <div class="controls">
                            <form:input path="staffid" cssClass="input-xlarge uneditable-input" readonly="true"/>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="deleted">Status</label>
                        <div class="controls">
                            <label class="radio">
                                <input type="radio" name="deleted" id="optionsRadios3" value="false" ${isCheckedC}>
                                Activated
                            </label>
                            <div style="clear:both"></div>
                            <label class="radio">
                                <input type="radio" name="deleted" id="optionsRadios4" value="true" ${isCheckedD}>
                                Deleted
                            </label>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio">
                                <input type="radio" name="gender" id="optionsRadios1" value="true" ${isCheckedA}>
                                Male
                            </label>
                            <div style="clear:both"></div>
                            <label class="radio">
                                <input type="radio" name="gender" id="optionsRadios2" value="false" ${isCheckedB}>
                                Female
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="controls">
                            <select id="departid" name="departid">
                                <c:forEach var="d" items="${lstDepart}">
                                    <c:choose>
                                        <c:when test="${d.departid==departidOfStaff}">
                                            <option value="${d.departid}" selected>${d.name}</option>
                                        </c:when>    
                                        <c:otherwise>
