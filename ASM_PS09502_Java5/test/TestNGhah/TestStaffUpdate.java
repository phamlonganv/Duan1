...
public class TestStaffUpdate {
    ...
    public void testInsert(int idStaff, String depart,String name ,String mail, boolean Gt,int Date,int salary, String photo,String note ) throws IllegalAccessException {
        ...
        Assert.assertTrue(staffDao.Update(staff), "User Test");
    ...
    public Object[][] dataTest() throws IOException {
        Data data = new Data();
        Object[][] a = data.getData(Data.file, "Tc_Staff_Up", 10);
    ...
    public void afterMethod(ITestResult result) throws IOException {
        ...
        Data data = new Data();
        data.writeResult(Data.file, "Tc_Staff_Up", testCount, 11, resultName);
