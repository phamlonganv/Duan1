...
public class TestDepartDelete {
    ...
    public void testInsert(String idDepart , String nameDepart )throws IllegalAccessException {
       ...
       boolean  kt = departDao.Delete(depart);
    ...
    public Object[][] dataTest() throws IOException {
        Data data = new Data();
        Object[][] a = data.getData(Data.file, "Tc_Depart_De", 3);
    ...
    public void afterMethod(ITestResult result) throws IOException {
        ...
        Data data = new Data();
        data.writeResult(Data.file, "Tc_Depart_De", testCount, 4, resultName);
