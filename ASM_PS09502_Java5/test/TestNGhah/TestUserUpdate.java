...
public class TestUserUpdate {
    ...
    public void testInsert(String username, String pass, String fullname, String image) throws IllegalAccessException {
        ...
        System.out.println(username+" "+pass+" "+fullname+" ");
        boolean ins = userDao.Update(us);
    ...
    public Object[][] dataTest() throws IOException {
        Data data = new Data();
        Object[][] a = data.getData(Data.file, "Tc_User_Up", 5);
    ...
    public void afterMethod(ITestResult result) throws IOException {
        ...
        Data data = new Data();
        data.writeResult(Data.file, "Tc_User_Up", testCount, 6, resultName);
